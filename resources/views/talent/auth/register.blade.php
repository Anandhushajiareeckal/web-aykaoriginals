...
<div class="auth-left">
  <div style="position:relative;z-index:1;max-width:400px;text-align:center">
    ...
    <span class="auth-logo-sub">Originals — Talent Portal</span>
    <p class="auth-tagline">Represent your talent. Create your professional profile and let the world discover your potential.</p>
  </div>
</div>
...
<div class="auth-right">
  <div class="auth-card">
    ...
    <p>Register to manage your talent profile on AYKA Originals.</p>

    <div class="note">
      ℹ️ Your profile will be reviewed by our team before appearing publicly on the agency roster.
    </div>

    <form method="POST" action="{{ route('talent.portal.register.post') }}">
      @csrf
